...
class App:
    def __init__(self, root):
        ...
        # --- Botón Guardar ---
        tk.Button(frame, text="Guardar Reporte", command=self.guardar_reporte,
                  bg="#4CAF50", fg="white", font=("Arial", 10, "bold")).grid(row=6, column=0, columnspan=2, pady=10)

        # --- Tabla para mostrar reportes ---
        self.tabla = ttk.Treeview(root, columns=("fecha", "orden", "inicio", "fin", "solucion", "tecnico"), show="headings")
    ...
    def guardar_reporte(self):
        ...
        self.solucion_entry.delete(0, tk.END)
